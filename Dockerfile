...
RUN mkdir pfaces; cd pfaces; wget https://github.com/parallall/pFaces/releases/download/Release_1.2.0d/pFaces-1.2.0-Ubuntu18.04.zip; unzip pFaces-1.1.0-Ubuntu18.04.zip; sh ./install.sh
