...
// -----------------------------------------
// MK: I added template function instatiation to make things work with g++
// on 15.04.2019
template Number<double>::Number(const double &t);
template Number<int>::Number(const int &t);
// it ends here
